...
export default function MeSettingsScreen() {
  ...
  // structure only – these switches don't do anything yet
  ...
  const onSelectLang = async (newLang: "en" | "zh") => {
    ...
    // Follow staff app: show dialog for result
    if (!ok) {
      showDialog(
        "error",
      ...
      showDialog(
        ...
        newLang === "en" ? t("settings_lang_set_en") : t("settings_lang_set_zh")
      );
    }
  };
    ...
    <SafeAreaView style={styles.safe} edges={["top", "bottom"]}>
      ...
      >
        ...
        <View style={styles.main}>
          <SectionCard title={t("settings_title")}>
            {/* Notifications */}
            ...
            {/* <View style={[styles.row, styles.rowWithBorder]}>
              <View style={styles.leftBlock}>
                <Text style={styles.rowTitle}>{t("settings_dark_mode")}</Text>
                <Text style={styles.rowSubtitle}>
